...
// establish a connection to IndexedDB database called 'pizza_hunt' and set it to ver1
const request = indexedDB.open('pizza_hunt', 1);

// this event will emit if the database version changes(nonexistant to ver1, v1 to v2, etc)
